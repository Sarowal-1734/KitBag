        ...
        buttonUpdatePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!newPassword.equals(conformNewPassword)){
                    Toast.makeText(PostActivity.this, "Conform Password Again", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onSuccess(Void unused) {
                ...
                currentUser.updatePassword(newPassword).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(PostActivity.this, "Password Update Successfully", Toast.LENGTH_SHORT).show();
                    }
